...
from microbiome_ml.main import load_data, filter_data, clr_transform
...
def test_load_data_empty_files(tmp_path):
    ...
    from microbiome_ml.data_processing import load_data
...
def test_filter_data_invalid_cutoffs(mock_abundance):
    from microbiome_ml.data_processing import filter_data
