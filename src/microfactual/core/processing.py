"""Functional data-processing primitives (load, filter, CLR).

These are the low-level building blocks used by :class:`MicrobiomeDataset` and
the CLI. The public, sklearn-style equivalents live in
...
def load_data(
    ...
    """Load and align microbiome abundance and metadata files.
...
def filter_data(
    ...
    """Filter features by abundance and prevalence thresholds.
